...
final case class Epoch(
    ...
    batches: _root_.scala.Seq[transaction.protocol.Batch] = _root_.scala.Seq.empty
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): transaction.protocol.Epoch = {
      var __id = this.id
      val __batches = (_root_.scala.collection.immutable.Vector.newBuilder[transaction.protocol.Batch] ++= this.batches)
      var _done__ = false
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 18 =>
            __batches += _root_.scalapb.LiteParser.readMessage(_input__, transaction.protocol.Batch.defaultInstance)
    ...
    def addBatches(__vs: transaction.protocol.Batch*): Epoch = addAllBatches(__vs)
    def addAllBatches(__vs: Iterable[transaction.protocol.Batch]): Epoch = copy(batches = batches ++ __vs)
    def withBatches(__v: _root_.scala.Seq[transaction.protocol.Batch]): Epoch = copy(batches = __v)
...
object Epoch extends scalapb.GeneratedMessageCompanion[transaction.protocol.Epoch] with transaction.Command {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): transaction.protocol.Epoch = {
    ...
    transaction.protocol.Epoch(
      ...
      __fieldsMap.getOrElse(__fields.get(1), Nil).asInstanceOf[_root_.scala.Seq[transaction.protocol.Batch]]
    )
  }
  implicit def messageReads: _root_.scalapb.descriptors.Reads[transaction.protocol.Epoch] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      transaction.protocol.Epoch(
        ...
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).map(_.as[_root_.scala.Seq[transaction.protocol.Batch]]).getOrElse(_root_.scala.Seq.empty)
      )
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 2 => __out = transaction.protocol.Batch
    }
    __out
  }
  ...
  implicit class EpochLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, transaction.protocol.Epoch]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, transaction.protocol.Epoch](_l) {
    ...
    def batches: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[transaction.protocol.Batch]] = field(_.batches)((c_, f_) => c_.copy(batches = f_))
  }
  final val ID_FIELD_NUMBER = 1
  final val BATCHES_FIELD_NUMBER = 2
  def of(
    id: _root_.scala.Predef.String,
    batches: _root_.scala.Seq[transaction.protocol.Batch]
